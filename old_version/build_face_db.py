...
MODEL_NAME = "ArcFace"            # Model nhận diện 
...
def build_database():
    ...
    for idx, student_id in enumerate(student_folders):
        ...
        # Duyệt qua từng file trong thư mục của học sinh đó
